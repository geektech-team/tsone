...
export const enContributingPages: DocPage[] = [
  {
    ...
    body: [
      ...
      paragraph(
        ...
        '. Both use the typed content registry and structured block helpers, and every page must have the same logical route in both directories. Chinese and English catalogs each contain exactly 17 logical routes; add or remove a route in both catalogs in the same change.'
      ),
      list([
