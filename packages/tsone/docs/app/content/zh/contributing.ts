...
export const contributingPages: DocPage[] = [
  {
    ...
    body: [
      ...
      list([
        ...
        [
          'CLI 首版配置不提供 plugins、WebSocket、HMR、SSR、函数式配置、public/ 复制以及公开的 minify/sourcemap 设置',
        ],
      ]),
      heading(2, '代码规范'),
      ...
      paragraph(
        ...
        '。两边都使用 typed content registry 和结构化 block helper；中英文逻辑路由必须一致。中英文 catalog 当前各包含 16 条逻辑路由；新增或删除路由时必须同步修改两边。'
      ),
      list([
